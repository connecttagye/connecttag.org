...
const CACHE_NAME = 'connecttag-cache-v66';
...
const ASSETS_TO_CACHE = [
  ...
  'https://connecttag.org/assets/css/styles.min.css?v=1.1.12',
  'https://connecttag.org/assets/css/shared-styles.css?v=1.1.12',
  'https://connecttag.org/assets/js/components/components-bundle.js?v=1.1.12',
  'https://connecttag.org/assets/js/components/pwa-install-prompt.js?v=1.1.12',
  'https://connecttag.org/assets/js/components/site-author-box.js?v=1.1.12'
];
